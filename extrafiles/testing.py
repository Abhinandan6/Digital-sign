...
SAMPLE_PUBLIC_KEY=b"""
-----BEGIN PUBLIC KEY-----

bwIDAQAB
-----END PUBLIC KEY-----
"""

def sign_document(file_path,SAMPLE_PRIVATE_KEY_DATA):
    try:
...
if __name__ == "__main__":
    ...
    sign_document(file_path,SAMPLE_PRIVATE_KEY_DATA)
